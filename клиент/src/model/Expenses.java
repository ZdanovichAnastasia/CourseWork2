...
public class Expenses implements Serializable {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this.idExpenses, this.expensesName, this.expensesGroup, this.expensesType, this.sumofExpenses, this.idCompany);// this.surname, this.phone, this.login, this.password, this.role);
    }
